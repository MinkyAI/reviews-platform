...
import { RefreshCw, Activity, Users, QrCode, Star, MousePointerClick, DollarSign } from 'lucide-react'
      ...
      <AnimatePresence mode="wait">
        {loading ? (
          ...
          >
            ...
            <KPICard
              title="Google CTR"
              value={data.kpis.googleClickthrough.value}
              change={data.kpis.googleClickthrough.change}
              trend={data.kpis.googleClickthrough.trend}
              format="percentage"
            ...
            <KPICard
              ...
              value={data.kpis.activeClients.value}
              change={data.kpis.activeClients.change}
              trend={data.kpis.activeClients.trend}
              icon={Users}
              delay={0.4}
            />
