      ...
      <div className="flex items-center justify-between h-16 px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-slate-500 truncate max-w-32 sm:max-w-none">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            >
              <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#34C759] to-[#30D158] flex items-center justify-center">
                <Store className="w-4 h-4 text-white" />
              </div>
              <div className="hidden md:block text-left">
                <p className="text-sm font-medium text-slate-900 truncate max-w-24">
                  {user?.name || user?.restaurant_name || 'Restaurant'}
                </p>
